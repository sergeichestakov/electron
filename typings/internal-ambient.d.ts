...
declare namespace NodeJS {
  interface ModuleInternal extends NodeJS.Module {
    new(id: string, parent?: NodeJS.Module): NodeJS.Module;
    _load(request: string, parent?: NodeJS.Module, isMain?: boolean): any;
    _resolveFilename(request: string, parent?: NodeJS.Module, isMain?: boolean, options?: { paths: string[] }): string;
